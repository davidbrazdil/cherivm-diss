...
The sandboxed code could embrace this mechanism to recover from the trap and to throw an appropriate Java exception. It would, however, be necessary to further consider how the host could recognize an unhandled trap... [ TODO ]
