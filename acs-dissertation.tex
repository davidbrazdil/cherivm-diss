...
\begin{itemize}
\item full support of the Java and JNI specification (versions 5 and 1.4 respectively),
...
\end{itemize}
interpreter -> unlikely to get noticible performance gain from hardware bounds checking
