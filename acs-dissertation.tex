...
\end{itemize}
The price is that JamVM is merely a Java interpreter and thus is unlikely to see any performance gain from optimizations which could be achieved with the CHERI ISA, namely hardware bounds checking (a common Java bottleneck~[REF]).

\section{Sandboxing Libraries}
