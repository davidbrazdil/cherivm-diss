...
For this reason, the VM is currently forced to acquire a global reentrant lock before it invokes a sandbox object. Multithreaded access to the sandbox is also not discussed in this dissertation and its implications on the protection mechanisms would require very careful and detailed consideration.
